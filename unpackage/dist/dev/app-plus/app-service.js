...
(function(vue) {
  ...
  const S = true, b = "app", T = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), A = b, P = I('{"address":["127.0.0.1","10.30.108.143"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","D:/HBuilderX.4.55.2025030718/HBuilderX/plugins/unicloud/**/*.js"]}'), C = I('[{"provider":"aliyun","spaceName":"pdd","spaceId":"mp-0dcd11a4-5797-4c2e-9b6e-d28808479dcd","clientSecret":"OmlJkqdgJblOVBVMC7xDug==","endpoint":"https://api.next.bspapp.com"}]') || [];
  let O = "";
  try {
    O = "__UNI__1D20EA0";
  } catch (e2) {
...
详细信息：${s4}`), r3(i3);
  ...
  const __easycom_0$7 = /* @__PURE__ */ _export_sfc(_sfc_main$Q, [["render", _sfc_render$P], ["__scopeId", "data-v-d31e1c47"], ["__file", "G:/pdd/uni_modules/uni-icons/components/uni-icons/uni-icons.vue"]]);
  ...
  const __easycom_2$1 = /* @__PURE__ */ _export_sfc(_sfc_main$P, [["render", _sfc_render$O], ["__scopeId", "data-v-09fd5285"], ["__file", "G:/pdd/uni_modules/uni-easyinput/components/uni-easyinput/uni-easyinput.vue"]]);
  const _sfc_main$O = {
    name: "uniFormsItem",
    options: {
      virtualHost: true
  ...
  const __easycom_3$3 = /* @__PURE__ */ _export_sfc(_sfc_main$O, [["render", _sfc_render$N], ["__scopeId", "data-v-462874dd"], ["__file", "G:/pdd/uni_modules/uni-forms/components/uni-forms-item/uni-forms-item.vue"]]);
  var pattern = {
    email: /^\S+?@\S+?\.\S+?$/,
  ...
  const __easycom_4 = /* @__PURE__ */ _export_sfc(_sfc_main$N, [["render", _sfc_render$M], ["__scopeId", "data-v-9a1e3c32"], ["__file", "G:/pdd/uni_modules/uni-forms/components/uni-forms/uni-forms.vue"]]);
  const config = {
    // 调试模式
    debug: false,
    /*
  ...
  const UniModulesUniIdPagesPagesLoginLoginWithpwd = /* @__PURE__ */ _export_sfc(_sfc_main$M, [["render", _sfc_render$L], ["__file", "G:/pdd/uni_modules/uni-id-pages/pages/login/login-withpwd.vue"]]);
  ...
  const _sfc_main$L = {
    ...
    methods: {
      ...
      async checkUserInfoSync() {
        formatAppLog("log", "at pages/index/index.vue:159", "开始同步检查用户信息");
        if (!store.hasLogin) {
          formatAppLog("log", "at pages/index/index.vue:163", "用户未登录，跳过信息检查");
        ...
        while (!store.userInfo && attempts < maxAttempts) {
          formatAppLog("log", "at pages/index/index.vue:173", `等待用户信息加载，尝试 ${attempts + 1}/${maxAttempts}`);
          await new Promise((resolve) => setTimeout(resolve, 300));
          attempts++;
        }
        this.userInfoChecked = true;
        if (!store.userInfo) {
          formatAppLog("log", "at pages/index/index.vue:182", "用户信息加载超时或不存在");
          this.userInfoComplete = false;
          return;
        }
        formatAppLog("log", "at pages/index/index.vue:187", "检查用户信息:", store.userInfo);
        ...
        formatAppLog("log", "at pages/index/index.vue:192", "用户信息检查结果:", {
          hasMobile,
          hasAddress
        });
        this.userInfoComplete = hasMobile && hasAddress;
        if (!this.userInfoComplete) {
          formatAppLog("log", "at pages/index/index.vue:200", "用户信息不完整，需要补充");
          uni.showToast({
            title: "请完善手机与收货地址",
            icon: "none",
            duration: 2e3
          ...
          formatAppLog("log", "at pages/index/index.vue:214", "用户信息已完整");
        }
      },
      // 保留原有方法，但主要用于onShow时的检查
      checkUserInfo(silent = false) {
        if (!store.hasLogin) {
          formatAppLog("log", "at pages/index/index.vue:222", "用户未登录，跳过信息检查");
          return;
        }
        const userInfo = store.userInfo;
        if (!userInfo) {
          formatAppLog("log", "at pages/index/index.vue:228", "用户信息不存在，跳过信息检查");
          return;
        }
        formatAppLog("log", "at pages/index/index.vue:232", "检查用户信息:", JSON.stringify(userInfo));
        const hasMobile = !!userInfo.mobile && userInfo.mobile.trim() !== "";
        const hasAddress = !!userInfo.address && userInfo.address.trim() !== "";
        formatAppLog("log", "at pages/index/index.vue:237", "用户信息检查结果:", {
          hasMobile,
          hasAddress
        });
        this.userInfoComplete = hasMobile && hasAddress;
        if (this.userInfoComplete) {
          formatAppLog("log", "at pages/index/index.vue:245", "用户信息已完整");
          return true;
        } else {
          formatAppLog("log", "at pages/index/index.vue:248", "用户信息不完整，需要补充");
          if (!silent) {
            uni.showToast({
              title: "请完善手机与收货地址",
              icon: "none",
      ...
      async getInitialData() {
        try {
          ...
          formatAppLog("error", "at pages/index/index.vue:279", "初始化数据失败:", err2);
      ...
      async fetchAndCacheData() {
        try {
          ...
          formatAppLog("error", "at pages/index/index.vue:310", "获取数据失败:", err2);
          throw err2;
        }
      },
      setPageData(data2) {
      ...
      navigateToProduct(item) {
        ...
        uni.setStorage({
          ...
          data: item,
          success: () => {
            formatAppLog("log", "at pages/index/index.vue:367", "商品信息存储成功", item);
          }
        });
        uni.navigateTo({
      ...
      onRefresh() {
        formatAppLog("log", "at pages/index/index.vue:376", "正在刷新...");
        this.isRefreshing = true;
        this.fetchAndCacheData().then(() => {
          this.switchTab(this.currentTab);
          this.isRefreshing = false;
        }).catch((error) => {
          formatAppLog("error", "at pages/index/index.vue:382", "刷新失败:", error);
          this.isRefreshing = false;
        });
      }
    }
  ...
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$L, [["render", _sfc_render$K], ["__file", "G:/pdd/pages/index/index.vue"]]);
  ...
  const UniModulesUniIdPagesPagesRegisterRegister = /* @__PURE__ */ _export_sfc(_sfc_main$K, [["render", _sfc_render$J], ["__file", "G:/pdd/uni_modules/uni-id-pages/pages/register/register.vue"]]);
  const popup = {
    data() {
      return {};
    },
  ...
  const __easycom_3$2 = /* @__PURE__ */ _export_sfc(_sfc_main$J, [["render", _sfc_render$I], ["__scopeId", "data-v-d78c88b7"], ["__file", "G:/pdd/uni_modules/uni-popup/components/uni-popup-dialog/uni-popup-dialog.vue"]]);
  class MPAnimation {
  ...
  const __easycom_0$6 = /* @__PURE__ */ _export_sfc(_sfc_main$I, [["render", _sfc_render$H], ["__file", "G:/pdd/uni_modules/uni-transition/components/uni-transition/uni-transition.vue"]]);
  const _sfc_main$H = {
    name: "uniPopup",
    components: {},
  ...
  const __easycom_0$5 = /* @__PURE__ */ _export_sfc(_sfc_main$H, [["render", _sfc_render$G], ["__scopeId", "data-v-4dd3c44b"], ["__file", "G:/pdd/uni_modules/uni-popup/components/uni-popup/uni-popup.vue"]]);
  ...
  const __easycom_5$2 = /* @__PURE__ */ _export_sfc(_sfc_main$G, [["render", _sfc_render$F], ["__scopeId", "data-v-40b82fe9"], ["__file", "G:/pdd/uni_modules/uni-id-pages/components/uni-id-pages-agreements/uni-id-pages-agreements.vue"]]);
  const _sfc_main$F = {
    computed: {
      agreements() {
        if (!config.agreements) {
  ...
  const __easycom_2 = /* @__PURE__ */ _export_sfc(_sfc_main$F, [["render", _sfc_render$E], ["__scopeId", "data-v-c5c7cfa0"], ["__file", "G:/pdd/uni_modules/uni-id-pages/components/uni-id-pages-fab-login/uni-id-pages-fab-login.vue"]]);
  let currentWebview;
  const _sfc_main$E = {
    mixins: [mixin],
    data() {
  ...
  const UniModulesUniIdPagesPagesLoginLoginWithoutpwd = /* @__PURE__ */ _export_sfc(_sfc_main$E, [["render", _sfc_render$D], ["__file", "G:/pdd/uni_modules/uni-id-pages/pages/login/login-withoutpwd.vue"]]);
  const _sfc_main$D = {
    props: {
      modelValue: String,
      value: String,
  ...
  const __easycom_0$4 = /* @__PURE__ */ _export_sfc(_sfc_main$D, [["render", _sfc_render$C], ["__scopeId", "data-v-a00179ae"], ["__file", "G:/pdd/uni_modules/uni-captcha/components/uni-captcha/uni-captcha.vue"]]);
  ...
  const __easycom_3$1 = /* @__PURE__ */ _export_sfc(_sfc_main$C, [["render", _sfc_render$B], ["__scopeId", "data-v-4b649130"], ["__file", "G:/pdd/uni_modules/uni-id-pages/components/uni-id-pages-sms-form/uni-id-pages-sms-form.vue"]]);
  const _sfc_main$B = {
    data() {
      return {
        focus: false
  ...
  const __easycom_5$1 = /* @__PURE__ */ _export_sfc(_sfc_main$B, [["render", _sfc_render$A], ["__scopeId", "data-v-d021b99b"], ["__file", "G:/pdd/uni_modules/uni-captcha/components/uni-popup-captcha/uni-popup-captcha.vue"]]);
  const _sfc_main$A = {
    mixins: [mixin],
    data() {
      return {
  ...
  const UniModulesUniIdPagesPagesLoginLoginSmscode = /* @__PURE__ */ _export_sfc(_sfc_main$A, [["render", _sfc_render$z], ["__scopeId", "data-v-661d78f6"], ["__file", "G:/pdd/uni_modules/uni-id-pages/pages/login/login-smscode.vue"]]);
  const _sfc_main$z = {
    name: "cloud-image",
    emits: ["click"],
    props: {
  ...
  const __easycom_0$3 = /* @__PURE__ */ _export_sfc(_sfc_main$z, [["render", _sfc_render$y], ["__file", "G:/pdd/uni_modules/uni-id-pages/components/cloud-image/cloud-image.vue"]]);
  const _sfc_main$y = {
    data() {
      return {
        isPC: false
  ...
  const __easycom_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$y, [["render", _sfc_render$x], ["__scopeId", "data-v-a428f129"], ["__file", "G:/pdd/uni_modules/uni-id-pages/components/uni-id-pages-avatar/uni-id-pages-avatar.vue"]]);
  const _sfc_main$x = {
    name: "UniBadge",
    emits: ["click"],
    props: {
  ...
  const __easycom_1$2 = /* @__PURE__ */ _export_sfc(_sfc_main$x, [["render", _sfc_render$w], ["__scopeId", "data-v-c97cb896"], ["__file", "G:/pdd/uni_modules/uni-badge/components/uni-badge/uni-badge.vue"]]);
  const _sfc_main$w = {
    name: "UniListItem",
  ...
  const __easycom_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$w, [["render", _sfc_render$v], ["__scopeId", "data-v-c7524739"], ["__file", "G:/pdd/uni_modules/uni-list/components/uni-list-item/uni-list-item.vue"]]);
  const _sfc_main$v = {
    name: "uniList",
    "mp-weixin": {
      options: {
  ...
  const __easycom_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$v, [["render", _sfc_render$u], ["__scopeId", "data-v-c2f1266a"], ["__file", "G:/pdd/uni_modules/uni-list/components/uni-list/uni-list.vue"]]);
  ...
  const __easycom_5 = /* @__PURE__ */ _export_sfc(_sfc_main$u, [["render", _sfc_render$t], ["__scopeId", "data-v-e0127e04"], ["__file", "G:/pdd/uni_modules/uni-id-pages/components/uni-id-pages-bind-mobile/uni-id-pages-bind-mobile.vue"]]);
  ...
  const UniModulesUniIdPagesPagesUserinfoUserinfo = /* @__PURE__ */ _export_sfc(_sfc_main$t, [["render", _sfc_render$s], ["__scopeId", "data-v-0be2f605"], ["__file", "G:/pdd/uni_modules/uni-id-pages/pages/userinfo/userinfo.vue"]]);
  ...
  const __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$s, [["render", _sfc_render$r], ["__scopeId", "data-v-ab02960b"], ["__file", "D:/HBuilderX.4.55.2025030718/HBuilderX/plugins/uniapp-cli-vite/node_modules/@dcloudio/uni-components/lib/uni-match-media/uni-match-media.vue"]]);
  const _sfc_main$r = {
    data() {
      return {
        formData: {
  ...
  const UniModulesUniIdPagesPagesUserinfoBindMobileBindMobile = /* @__PURE__ */ _export_sfc(_sfc_main$r, [["render", _sfc_render$q], ["__file", "G:/pdd/uni_modules/uni-id-pages/pages/userinfo/bind-mobile/bind-mobile.vue"]]);
  ...
  const limeClipper = /* @__PURE__ */ _export_sfc(_sfc_main$q, [["render", _sfc_render$p], ["__scopeId", "data-v-5dd2a2ff"], ["__file", "G:/pdd/uni_modules/uni-id-pages/pages/userinfo/cropImage/limeClipper/limeClipper.vue"]]);
  const _sfc_main$p = {
  ...
  const UniModulesUniIdPagesPagesUserinfoCropImageCropImage = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["render", _sfc_render$o], ["__file", "G:/pdd/uni_modules/uni-id-pages/pages/userinfo/cropImage/cropImage.vue"]]);
  ...
  const __easycom_3 = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["render", _sfc_render$n], ["__scopeId", "data-v-bcd6b47b"], ["__file", "G:/pdd/uni_modules/uni-id-pages/components/uni-id-pages-email-form/uni-id-pages-email-form.vue"]]);
  ...
  const UniModulesUniIdPagesPagesRegisterRegisterByEmail = /* @__PURE__ */ _export_sfc(_sfc_main$n, [["render", _sfc_render$m], ["__file", "G:/pdd/uni_modules/uni-id-pages/pages/register/register-by-email.vue"]]);
  ...
  const UniModulesUniIdPagesPagesRetrieveRetrieve = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["render", _sfc_render$l], ["__file", "G:/pdd/uni_modules/uni-id-pages/pages/retrieve/retrieve.vue"]]);
  ...
  const UniModulesUniIdPagesPagesRetrieveRetrieveByEmail = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["render", _sfc_render$k], ["__file", "G:/pdd/uni_modules/uni-id-pages/pages/retrieve/retrieve-by-email.vue"]]);
  const _sfc_main$k = {
    onLoad({ url, title }) {
  ...
  const UniModulesUniIdPagesPagesCommonWebviewWebview = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["render", _sfc_render$j], ["__file", "G:/pdd/uni_modules/uni-id-pages/pages/common/webview/webview.vue"]]);
  ...
  const UniModulesUniIdPagesPagesUserinfoChangePwdChangePwd = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["render", _sfc_render$i], ["__file", "G:/pdd/uni_modules/uni-id-pages/pages/userinfo/change_pwd/change_pwd.vue"]]);
  ...
  const UniModulesUniIdPagesPagesRegisterRegisterAdmin = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["render", _sfc_render$h], ["__file", "G:/pdd/uni_modules/uni-id-pages/pages/register/register-admin.vue"]]);
  ...
  const UniModulesUniIdPagesPagesUserinfoSetPwdSetPwd = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["render", _sfc_render$g], ["__scopeId", "data-v-e5e1f63f"], ["__file", "G:/pdd/uni_modules/uni-id-pages/pages/userinfo/set-pwd/set-pwd.vue"]]);
  const _sfc_main$g = {
    data() {
      return {};
    },
  ...
  const UniModulesUniIdPagesPagesUserinfoDeactivateDeactivate = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["render", _sfc_render$f], ["__file", "G:/pdd/uni_modules/uni-id-pages/pages/userinfo/deactivate/deactivate.vue"]]);
  ...
  const UniModulesUniIdPagesPagesUserinfoRealnameVerifyRealnameVerify = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["render", _sfc_render$e], ["__file", "G:/pdd/uni_modules/uni-id-pages/pages/userinfo/realname-verify/realname-verify.vue"]]);
  ...
  const PagesChatChat = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["render", _sfc_render$d], ["__file", "G:/pdd/pages/chat/chat.vue"]]);
  ...
  const PagesUserUser = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$c], ["__file", "G:/pdd/pages/user/user.vue"]]);
  ...
  const PagesSearchSearch = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["render", _sfc_render$b], ["__file", "G:/pdd/pages/search/search.vue"]]);
  const _sfc_main$b = {
    data() {
      return {
        refreshing: false,
  ...
  const PagesSearchMallList = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$a], ["__file", "G:/pdd/pages/search/mall-list.vue"]]);
  const _sfc_main$a = {
    data() {
      return {
        goodsInfo: null,
    ...
    async onLoad(options) {
      ...
      formatAppLog("log", "at pages/search/mall-details.vue:179", "Initial userInfo:", store.userInfo);
    ...
    methods: {
      async loadGoodsInfo(options) {
        ...
        try {
          ...
          formatAppLog("log", "at pages/search/mall-details.vue:220", "商品详情页数据", this.goodsInfo);
        } catch (e) {
          formatAppLog("error", "at pages/search/mall-details.vue:222", "获取商品信息失败:", e);
        } finally {
      ...
      async checkFavoriteStatus() {
        if (!store.userInfo || !this.goodsInfo)
          return;
        formatAppLog("log", "at pages/search/mall-details.vue:230", "用户id", store.userInfo._id);
        formatAppLog("log", "at pages/search/mall-details.vue:231", "商品id", this.goodsInfo._id);
        const db2 = nr.database();
      ...
      async addToHistory() {
        if (!this.goodsInfo || !store.userInfo) {
          formatAppLog("warn", "at pages/search/mall-details.vue:244", "商品信息或用户信息为空，无法记录到历史浏览");
          return;
        }
        const db2 = nr.database();
        ...
        try {
          ...
          if (queryResult.result.data.length === 0) {
            ...
            formatAppLog("log", "at pages/search/mall-details.vue:265", "商品已记录到历史浏览");
          } else {
            formatAppLog("log", "at pages/search/mall-details.vue:267", "商品已存在于历史浏览中");
          }
        } catch (error) {
          formatAppLog("error", "at pages/search/mall-details.vue:270", "记录商品到历史浏览失败", error);
        }
      },
      ...
      async handlePayment() {
        ...
        formatAppLog("log", "at pages/search/mall-details.vue:380", "支付数据", paymentData);
        ...
        try {
          ...
          formatAppLog("log", "at pages/search/mall-details.vue:403", "orderResult", orderResult);
          if (orderResult && orderResult.result && orderResult.result.id) {
            uni.setStorageSync("currentOrderIds", [orderResult.result.id]);
            formatAppLog("log", "at pages/search/mall-details.vue:408", "orderResult.id", orderResult.result.id);
            uni.navigateTo({
              url: "/pages/wallet/pay"
            });
          } else {
            formatAppLog("error", "at pages/search/mall-details.vue:413", "订单创建成功，但未返回有效的 orderResult");
            uni.showToast({
              title: "创建订单失败，请重试",
              icon: "none"
            });
          ...
          formatAppLog("error", "at pages/search/mall-details.vue:420", "创建订单失败:", error);
          uni.showToast({
            title: "创建订单失败，请重试",
            icon: "none"
          });
  ...
  const PagesSearchMallDetails = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["render", _sfc_render$9], ["__file", "G:/pdd/pages/search/mall-details.vue"]]);
  const _sfc_main$9 = {
    data() {
      return {
        walletInfo: {
  ...
  const PagesWalletWallet = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$8], ["__file", "G:/pdd/pages/wallet/wallet.vue"]]);
  const _sfc_main$8 = {
    data() {
      return {
        paymentData: {
  ...
  const PagesWalletPay = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$7], ["__file", "G:/pdd/pages/wallet/pay.vue"]]);
  const en = {
  ...
  const __easycom_1 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$6], ["__scopeId", "data-v-9245e42c"], ["__file", "G:/pdd/uni_modules/uni-load-more/components/uni-load-more/uni-load-more.vue"]]);
  ...
  const PagesMallsManageFavor = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$5], ["__file", "G:/pdd/pages/malls-manage/favor.vue"]]);
  const _sfc_main$5 = {
    data() {
      return {
        historyItems: [],
  ...
  const PagesMallsManageHistory = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["__file", "G:/pdd/pages/malls-manage/history.vue"]]);
  ...
  const _sfc_main$4 = {
    ...
    methods: {
      ...
      navigateToProductDetails(productId) {
        ...
        formatAppLog("log", "at pages/user/order.vue:625", "跳转商品详情页的商品id", productId);
        const db2 = nr.database();
        db2.collection("mall-goods").doc(productId).get().then((res) => {
          formatAppLog("log", "at pages/user/order.vue:628", "跳转商品详情页的商品数据", res.result.data[0]);
          if (res.result.data) {
            uni.setStorage({
              key: "currentProduct",
          ...
          formatAppLog("error", "at pages/user/order.vue:646", "获取商品详情失败:", err2);
          uni.showToast({
            title: "获取商品详情失败",
            icon: "none"
          });
  ...
  const PagesUserOrder = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["__file", "G:/pdd/pages/user/order.vue"]]);
  const _sfc_main$3 = {
    data() {
      return {
        username: "",
    ...
    methods: {
      loadUserInfo() {
        const userInfo = store.userInfo;
        formatAppLog("log", "at pages/user/set.vue:53", "之前用户信息", userInfo);
        if (userInfo) {
      ...
      async saveUserInfo() {
        ...
        try {
          ...
          formatAppLog("log", "at pages/user/set.vue:83", "之后用户信息", store.userInfo);
          uni.showToast({
            title: "保存成功",
            icon: "success"
          });
          ...
          formatAppLog("error", "at pages/user/set.vue:93", "保存用户信息失败:", error);
          uni.showToast({
            title: "保存失败，请重试",
            icon: "none"
          });
  ...
  const PagesUserSet = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["__file", "G:/pdd/pages/user/set.vue"]]);
  const _sfc_main$2 = {
    data() {
      return {
        currentTab: 0,
  ...
  const PagesSubsidySubsidy = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1], ["__file", "G:/pdd/pages/subsidy/subsidy.vue"]]);
  const _sfc_main$1 = {
    data() {
      return {
        currentTab: 0,
  ...
  const PagesBuyVegetablesBuyVegetables = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__file", "G:/pdd/pages/buy-vegetables/buy-vegetables.vue"]]);
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "G:/pdd/App.vue"]]);
  function createApp() {
