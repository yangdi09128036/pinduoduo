  ...
  methods: {
    async getInitialData() {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/buy-vegetables/buy-vegetables.vue:84", "获取数据失败:", err);
      }
    },
    async getCategories() {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/buy-vegetables/buy-vegetables.vue:92", "获取分类数据失败:", err);
      }
    },
    async getGoods() {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/buy-vegetables/buy-vegetables.vue:100", "获取商品数据失败:", err);
      }
    },
    async getBanners() {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/buy-vegetables/buy-vegetables.vue:109", "获取轮播图数据失败:", err);
      }
    },
    switchTab(index) {
    ...
    navigateToProduct(item) {
      ...
      common_vendor.index.setStorage({
        ...
        data: item,
        success: () => {
          common_vendor.index.__f__("log", "at pages/buy-vegetables/buy-vegetables.vue:142", "商品信息存储成功", item);
        }
      });
      common_vendor.index.navigateTo({
...
//# sourceMappingURL=../../../.sourcemap/mp-weixin/pages/buy-vegetables/buy-vegetables.js.map
